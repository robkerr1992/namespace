<template>
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div v-if="$page.props.flash.success && show" class="flex items-center justify-between max-w-7xl bg-green-500 rounded mt-5">
        ...
        <div v-if="($page.props.flash.error || Object.keys($page.props.errors).length > 0) && show" class="flex items-center justify-between max-w-7xl bg-red-500 rounded mt-5">
            <div class="flex items-center">
